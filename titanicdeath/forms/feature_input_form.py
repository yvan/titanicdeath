...
class FeatureInput(FlaskForm):
    ...
    age = IntegerField('age', validators=[validators.Required()], render_kw={"placeholder": "how old are you?"})
    siblings = IntegerField('siblings', validators=[validators.Required()], render_kw={"placeholder": "how many siblings do you have?"})
